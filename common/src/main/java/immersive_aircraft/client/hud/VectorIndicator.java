...
public class VectorIndicator implements Indicator {
    ...
    public void drawHUD(GuiGraphics context, Minecraft client, int baseX, int baseY, int width, EngineVehicle aircraft, int color, int[] edge) {
        ...
        if (edgeCheck(edge, 5, x0, y0)) {
            ...
            int rectWidth = 5;
            int rectHeight = 5;
            OverlayRenderer.renderLine(context, rectX, rectY, rectX + rectWidth, rectY, color);
            OverlayRenderer.renderLine(context, rectX + rectWidth, rectY, rectX + rectWidth, rectY + rectHeight, color);
            OverlayRenderer.renderLine(context, rectX + rectWidth, rectY + rectHeight, rectX, rectY + rectHeight, color);
            OverlayRenderer.renderLine(context, rectX, rectY + rectHeight, rectX, rectY, color);
    ...
    public void drawDials(GuiGraphics context, Minecraft client, int baseX, int baseY, int scale, EngineVehicle aircraft) {
        ...
        if (edgeCheck(edge0, 5, xr, yr)) {
            ...
            int rectWidth = 5;
            int rectHeight = 5;
            OverlayRenderer.renderLine(context, rectX, rectY, rectX + rectWidth, rectY, colorBG);
            OverlayRenderer.renderLine(context, rectX + rectWidth, rectY, rectX + rectWidth, rectY + rectHeight, colorBG);
            OverlayRenderer.renderLine(context, rectX + rectWidth, rectY + rectHeight, rectX, rectY + rectHeight, colorBG);
            OverlayRenderer.renderLine(context, rectX, rectY + rectHeight, rectX, rectY, colorBG);
